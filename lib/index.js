...
exports["default"] = exports.deleteConfigResponse = exports.deleteConfigRequest = exports.writeConfigResponse = exports.readConfigResponse = exports.writeConfigRequest = exports.readConfigRequest = void 0;
    ...
    value: function preloadBindings(ipcRenderer, fs) {
      ...
      return {
        ...
        initial: function initial() {
          ...
          if (typeof _this.initialFileData !== "undefined") {
            ...
            try {
              ...
              console.error("".concat(_this.rendererLog, " encountered error '").concat(error, "' when trying to read file '").concat(path, "'. This file is probably corrupted, does not exist or is empty; defaulting file value to '{}'."));
              _this.initialFileData = {};
            }
          } else {
            _this.initialFileData = {};
          }
    ...
    value: function mainBindings(ipcMain, browserWindow, fs) {
      ...
      ipcMain.on(deleteConfigRequest, function (IpcMainEvent, args) {
        ...
        try {
          ...
          fs.writeFileSync(_this2.ivFile, generateIv());
        } catch (error) {
          console.error("".concat(_this2.mainLog, " failed to reset data due to error: '").concat(error, "'."));
          success = false;
        }
