...
function () {
  function Store(options) {
    ...
    if (typeof options !== "undefined") {
      ...
      if ((typeof process === "undefined" ? "undefined" : _typeof(process)) === "object") {
        try {
          ...
          if (this.options.debug) console.log("".concat(this.logPrepend, "renderer initializing. Parsed 'storePath' value: '").concat(this.options.path, "'."));
        } catch (error) {
    ...
    if (this.options.debug) console.log("".concat(this.logPrepend, "Initialized store. Data file: '").concat(this.options.path, "'."));
  }
